...
top_left_x = 100 # where in te window do we star drawing
top_left_y = 150
...
# room 0 stores items that aren't in the game yet 

outdoor_rooms = range(1, 26) # declaring/assigning outdoor rooms
for planetsectors in range(1, 26): #rooms 1 to 25 are generated here
    GAME_MAP.append( ["The dusty planet surface", 13, 13, True, True] ) # += and append do the same
...
# the assert command is like an error alert,
# if the thing B4 the , false then display the error message, which is after: ,
